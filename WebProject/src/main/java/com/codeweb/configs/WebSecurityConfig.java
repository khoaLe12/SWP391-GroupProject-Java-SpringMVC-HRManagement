    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                    ...
                    .antMatchers("/interviewer/schedules",
                    ...
                    .antMatchers("/manager/jobapps", "/manager/jobapps/job-app-detail", 
                            "/manager/post-detail/{postID}", 
                            "/manager/decision").hasRole("MANAGER")
                    .antMatchers("/department",
                            "/createjobposting","/createround",
                            "/view-post-detail/{postID}","/viewround",
                            "/deletejobposting/**").hasRole("DEPARTMENT")
